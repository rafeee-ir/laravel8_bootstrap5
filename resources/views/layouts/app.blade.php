                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('home') ? 'active' : ''}}" href="/home">پنل
                                    کاربری</a>
                            </li>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="adminMenu">
                                        <li class="nav-item">
                                            <a class="dropdown-item {{ request()->is('users') ? 'active' : ''}}"
                                               href="/users">مدیریت کاربران</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="dropdown-item {{ request()->is('roles') ? 'active' : ''}}"
                                               href="/roles">مدیریت نقشها</a>
                                        </li>
                                    </ul>
                                </li>
                            @endcanany
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="insMenu"
                                   role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                   سرویس های آنلاین
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="insMenu">
                                    <li class="nav-item">
                                        <a class="dropdown-item {{ request()->is('ins/body') ? 'active' : ''}}"
                                           href="/ins/body">بیمه بدنه</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="dropdown-item {{ request()->is('ins/third') ? 'active' : ''}}"
                                           href="/ins/third">بیمه ثالث</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
